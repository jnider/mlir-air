...
int main(int argc, char *argv[]) {
  ...
  //
  // 8 Shim DMAs used in this test. MB controller drives them all
  // simultaneously. NOTE: MB memcpy staging/progress slots are directly mapped,
  // i.e. odd and
  ...
  air_packet_nd_memcpy(&pkt_a, 0, 7, 1, 0, 4, 2,
                       reinterpret_cast<uint64_t>(dram_ptr_1) /*AIR_BBUFF_BASE*/,
