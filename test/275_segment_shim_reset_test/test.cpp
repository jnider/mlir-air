...
#define DMA_COUNT 16
  ...
  air_packet_nd_memcpy(&pkt, 0, reset_col, 1, 0, 4, 2, reinterpret_cast<uint64_t>(src_0),
  ...
  air_packet_nd_memcpy(&pkt2, 0, reset_col, 0, 0, 4, 2,
                       reinterpret_cast<uint64_t>(dst_0), DMA_COUNT * sizeof(float), 1,
                       0, 1, 0, 1, 0);
  ...
  air_packet_nd_memcpy(&pkt3, 0, non_reset_col, 1, 0, 4, 2,
                       reinterpret_cast<uint64_t>(src_1), DMA_COUNT * sizeof(float), 1,
                       0, 1, 0, 1, 0);
  ...
  air_packet_nd_memcpy(&pkt4, 0, non_reset_col, 0, 0, 4, 2,
                       reinterpret_cast<uint64_t>(dst_1), DMA_COUNT * sizeof(float), 1,
                       0, 1, 0, 1, 0);
  ...
  air_queue_dispatch_and_wait(&agents[0], queues[0], packet_id, wr_idx, &segment_pkt_two);
