...
main(int argc, char *argv[])
{
  ...
  air_packet_nd_memcpy(
      &pkt_c, 0, col, 0, 0, 4, 2,
      reinterpret_cast<uint64_t>(dram_ptr_3) /*DDR_ADDR+(2*IMAGE_SIZE*sizeof(float))*/,
  ...
  air_packet_nd_memcpy(
      &pkt_a, 0, col, 1, 0, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_1) /*DDR_ADDR*/,
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  ...
  air_packet_nd_memcpy(
      &pkt_b, 0, col, 1, 1, 4, 2,
      reinterpret_cast<uint64_t>(dram_ptr_2) /*DDR_ADDR+(IMAGE_SIZE*sizeof(float))*/,
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
