...
int main(int argc, char *argv[])
{
  ...
  air_packet_aie_lock_range(&lock_pkt, herd_id, lock_id, 0,
                            0, 0, num_cols, 0, num_rows);
  air_queue_dispatch_and_wait(&agents[0], queues[0], packet_id, wr_idx, &lock_pkt);
  ...
  if (errors) {
    ...
    air_packet_aie_lock_range(&release_pkt, herd_id, lock_id, 1,
                            1, 0, num_cols, 0, num_rows);
    air_queue_dispatch_and_wait(&agents[0], queues[0], packet_id, wr_idx, &release_pkt);
