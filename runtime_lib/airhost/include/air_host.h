...
hsa_status_t air_queue_dispatch(hsa_queue_t *queue, uint64_t packet_id, uint64_t doorbell,
...
// TODO: Remove this duplicaiton and use C++ templates, need to move some things around 
// for that
hsa_status_t air_queue_dispatch(hsa_queue_t *queue, uint64_t packet_id, uint64_t doorbell,
                                hsa_barrier_and_packet_t *pkt);
hsa_status_t air_queue_wait(hsa_queue_t *queue, hsa_barrier_and_packet_t *pkt);
hsa_status_t air_queue_dispatch_and_wait(hsa_agent_t *agent, hsa_queue_t *queue, uint64_t packet_id, uint64_t doorbell,
                                         hsa_barrier_and_packet_t *pkt, bool destroy_signal = true);
